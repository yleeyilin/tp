...
public class Messages {
    ...
    public static final String MESSAGE_INVALID_FIELD_FORMAT = "Failed to add Pooch Contact - \n"
            + "Invalid field detected : %1$s";
    public static final String MESSAGE_MISSING_FIELD_FORMAT = "Failed to add Pooch Contact - \n"
            + "Missing field detected : %1$s";
